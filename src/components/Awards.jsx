    ...
    <section id="awards" className="section-pad section-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {awards.map((award, index) => (
            <Reveal key={award.title} delay={index * 70}>
              <div className="card-ui-hover relative overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <Reveal className="mt-6">
          <div className="grid gap-6 rounded-[1.75rem] border border-blue-100 bg-blue-50/65 p-6 md:grid-cols-[1.2fr_0.8fr] md:items-center md:p-8">
            <div>
