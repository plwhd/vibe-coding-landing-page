...
export default function Rules() {
  return (
    <section id="rules" className="section-pad section-soft">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          <Reveal>
            <div className="card-ui rounded-[1.75rem] p-6">
              ...
              <div className="space-y-4">
                {rules.review.map((item) => (
                  <div key={item.title} className="subtle-panel rounded-3xl p-5">
            ...
            <div className="card-ui rounded-[1.75rem] p-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {rules.submission.map((item) => (
                  <div key={item} className="subtle-panel flex gap-3 rounded-3xl p-5">
              ...
              <details className="mt-5 rounded-3xl border border-slate-200 bg-white/80 p-5">
