...
export const jobs = [
  {
    ...
    category: '研发',
    duties: ['参与云服务核心系统开发', '设计高并发、高可用后端服务', '推动工程效率和系统稳定性优化'],
    requirements: ['扎实的数据结构与算法基础', '熟悉 Go / Java / C++ 任一语言', '理解数据库、缓存、消息队列等基础组件'],
    bonus: '有分布式系统、云计算或开源项目经验'
  },
  {
    title: '前端开发工程师',
    cities: ['上海', '杭州', '深圳', '西安'],
    category: '研发',
    duties: ['建设云平台控制台与开发者工具', '实现复杂交互和可视化页面', '优化前端性能与工程化体验'],
    requirements: ['熟悉 HTML、CSS、JavaScript / TypeScript', '掌握 React 或同类框架', '重视用户体验和代码质量'],
    bonus: '有组件库、低代码、可视化或大型前端项目经验'
  },
  {
    title: '全栈开发工程师',
    cities: ['上海', '杭州'],
