...
- 设计师备注
  - 此项目定位中不要使用“更适合，而不仅是”“不只是，也包括”这样的ai句式
  - 思考这一部分内容是否有必要保留

- 设计师备注-整体README.md 文档
  - 明确README.md 文档的受众群体，是设计师还是前端人员/程序员
  - 如果是设计师，或者前端程序员， 交付说明模块是否有必要写那么详细。前端程序员肯定会了解npm 命令等，需要判断是否有必要写的很详细。